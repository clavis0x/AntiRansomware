...
public:
	...
	BOOL LoadSthImage(UINT id, LPCTSTR pType);
	BOOL LoadAltImage(UINT id, LPCTSTR pType);
	BOOL LoadAlhImage(UINT id, LPCTSTR pType);
	...
	BOOL IsToggled() { return m_bIsToggled; }
...
protected:
	...
	BOOL	m_bHaveSthImage;
	BOOL	m_bHaveAltImage;
	BOOL	m_bHaveAlhImage;
	BOOL	m_bHaveBitmaps;
	...
	CGdiPlusBitmapResource* m_pSthImage;
	CGdiPlusBitmapResource* m_pAltImage;
	CGdiPlusBitmapResource* m_pAlhImage;
